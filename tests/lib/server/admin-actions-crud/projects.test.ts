...
describe('projects CRUD server actions', () => {
  beforeEach(() => {
    ...
    mockGetGenerationNameById.mockResolvedValue({ name: 'seed-gen' })
  ...
  it('creates project and invalidates locale-scoped public cache', async () => {
    ...
    expect(mockInvalidateProjectPublicCache).toHaveBeenCalledWith({
      projectId: '00000000-0000-4000-8000-000000000111',
  ...
  it('deletes project from shared delete action path', async () => {
    ...
    mockGetProjectCacheContext.mockResolvedValue({
      projectId: '00000000-0000-4000-8000-000000000666',
      generationName: 'seed-gen',
    })
