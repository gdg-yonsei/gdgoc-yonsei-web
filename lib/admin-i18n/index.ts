...
const adminMessages = {
  en: {
    ...
    allParts: 'All Parts',
    searchMemberPlaceholder: 'Search by name...',
  ...
  ko: {
    ...
    exportCsv: 'CSV 내보내기',
    allParts: '전체 파트',
    searchMemberPlaceholder: '이름으로 검색...',
    selectAllFiltered: '표시된 멤버 모두 선택',
    deselectAllFiltered: '표시된 멤버 선택 해제',
    selectedCount: '선택됨',
    allRoles: '전체 권한',
    sortBy: '정렬',
    sortByName: '이름순',
